...
export function generateFallbackPOI(lat: number, lon: number): Partial<CompanionData> {
  ...
  return {
    convenience1: { name: "該当なし(5km)", distance: null, bearing: null },
    convenience2: null,
    toilet1: { name: "該当なし(5km)", distance: null, bearing: null },
    toilet2: null,
    wifi1: { name: "該当なし(5km)", distance: null, bearing: null },
    wifi2: null,
    gas1: { name: "該当なし(5km)", distance: null, bearing: null },
    gas2: null,
    parking1: { name: "該当なし(5km)", distance: null, bearing: null },
    parking2: null,
    ...
    station2: null,
    bus1: { line: "-", name: "該当なし(5km)", distance: null, bearing: null, nextBus: "-" },
    bus2: null,
    gourmet1: { name: "該当なし(5km)", rating: null, distance: null, bearing: null },
    gourmet2: null,
    attraction1: { name: "該当なし(5km)", distance: null, bearing: null },
    attraction2: null,
